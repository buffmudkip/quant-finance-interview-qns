...
| **4.4** | Discrete & Continuous Distributions | reference tables (CDF/pmf/pdf/E/Var) · discrete (Uniform, Binomial, Poisson, Geometric, Neg. Binomial) & continuous (Uniform, Normal, Exponential, Gamma, Beta) with use cases · worked Umamusume gacha example (5 rate-up SSRs → ~667 pulls) |
